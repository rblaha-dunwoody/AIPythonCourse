# Exercise: Apply data augmentation to a dataset and train a fine-tuned model. Experiment with hyperparameters to observe their impact on performance.
import torch
...
for epoch in range(10):
    model.train()
    for inputs, labels in train_leader:
        optimizer.zero_grad()
