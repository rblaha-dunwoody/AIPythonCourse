# Exercise: Fine-tune a pre-trained model on a domain-specific dataset (e.g., BERT for medical text classification) and experiment with domain-specific embeddings
