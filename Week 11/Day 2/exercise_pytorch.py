# Exercise 1: Build a simple RNN model for text classification using TensorFlow or PyTorch
import torch
...
# Exercise 2: Train the RNN and observe how it captures sequence patterns
