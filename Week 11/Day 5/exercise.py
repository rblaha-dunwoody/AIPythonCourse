# Exercise: Preprocess a text dataset and integrate word embeddings (e.g., GloVe) into an LSTM model for sentiment analysis
...
# Decode reviews for preprocessing
...
print(f"LSTM model without GloVe Test Accuracy: {lstm_accuracy:.4f}")
