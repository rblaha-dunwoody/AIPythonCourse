# Exercise: Implement positional encoding and integrate it with a basic Transformer model
import numpy as np
...
# Exercise: Experiment with different positional encoding methods and observe the effects
import torch
...
learnable_positional_encoding = LearnablePositionalEncoding(seq_len, embed_dim)
print(learnable_positional_encoding)