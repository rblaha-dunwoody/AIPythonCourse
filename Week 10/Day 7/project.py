# Project: Build, train, and optimize a CNN for Fashion MNIST or CIFAR-10 image classification, 
# experimenting with regularization and data augmentation to achieve the best performance
import torch
