# Exercise 1: Implement both Grid Search and Random Search for hyperparameter tuning, compare their efficiency, and analyze the impact on model performace
...
y_pred_random = best_grid_model.predict(X_test)
