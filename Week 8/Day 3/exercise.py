...
# Grid Search - Define parameter grid
param_grid = {
...
# Grid Search - Train XGBoost with Grid Search
...
# Random Search - Train XGBoost with Random Search
...
# Random Search - Best parameters and accuracy
