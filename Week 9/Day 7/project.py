# Project: Build, train, and optimize a neural network for CIFAR-10 image classification, experimenting with hyperparameters to improve performance
...
plt.title("Accuracy Over Multiple Epochs")
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.legend()
plt.show()
...
plt.title("Loss Over Multiple Epochs")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
plt.show()
