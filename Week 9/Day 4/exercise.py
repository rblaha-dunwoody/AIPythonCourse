# Exercise: Implement gradient descent to update model weights and experiment with different optimizers using TensorFlow and/or PyTorch
import numpy as np
...
# Train with SGD
""" model = LinearModel()
optimizer = tf._optimizers.SGD(learning_rate=0.1)
